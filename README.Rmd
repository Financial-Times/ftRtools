...
network. Do not hard code you user name and password into files using these 
tools. Instead [save your credentials][credentials] in a ```.Renviron``` file 
in your home directory and include ```.Renviron``` in your ```.gitignore```. 
...
[Renviron]: http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html
